...
CREATE TABLE `__new_decay_schedule` (
	...
	`last_decay_at` integer DEFAULT '"2025-10-30T09:17:00.705Z"',
...
CREATE TABLE `__new_memories` (
	...
	`last_accessed` integer DEFAULT '"2025-10-30T09:17:00.704Z"',
	`created_at` integer DEFAULT '"2025-10-30T09:17:00.704Z"',
	`sector_id` text,
	`metadata` text,
...
--> statement-breakpoint
INSERT INTO `__new_memories`("id", "content", "embedding_id", "user_id", "chat_id", "user_type", "strength", "decay_rate", "initial_strength", "access_count", "reinforcement_count", "last_accessed", "created_at", "sector_id", "metadata") SELECT "id", "content", "embedding_id", "user_id", "chat_id", "user_type", "strength", "decay_rate", "initial_strength", "access_count", "reinforcement_count", "last_accessed", "created_at", "sector_id", "metadata" FROM `memories`;--> statement-breakpoint
...
CREATE TABLE `__new_memory_access_log` (
	...
	`strength_after` real,
	`accessed_at` integer DEFAULT '"2025-10-30T09:17:00.705Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_system_config` (
	...
	`updated_at` integer DEFAULT '"2025-10-30T09:17:00.705Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_vector_index` (
	...
	`created_at` integer DEFAULT '"2025-10-30T09:17:00.705Z"',
	`updated_at` integer DEFAULT '"2025-10-30T09:17:00.705Z"'
);
--> statement-breakpoint
