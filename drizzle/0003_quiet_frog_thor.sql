...
CREATE TABLE `__new_decay_schedule` (
	...
	`last_decay_at` integer DEFAULT '"2026-02-14T04:47:03.635Z"',
...
CREATE TABLE `__new_memories` (
	...
	`last_accessed` integer DEFAULT '"2026-02-14T04:47:03.634Z"',
	`created_at` integer DEFAULT '"2026-02-14T04:47:03.634Z"',
	`sector_id` text,
...
CREATE TABLE `__new_memory_access_log` (
	...
	`strength_after` real,
	`accessed_at` integer DEFAULT '"2026-02-14T04:47:03.634Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_system_config` (
	...
	`updated_at` integer DEFAULT '"2026-02-14T04:47:03.635Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_vector_index` (
	...
	`memory_id` text NOT NULL,
	`vector_bytes` blob,
	`dimension` integer DEFAULT 768 NOT NULL,
	`created_at` integer DEFAULT '"2026-02-14T04:47:03.634Z"',
	`updated_at` integer DEFAULT '"2026-02-14T04:47:03.634Z"'
);
--> statement-breakpoint
